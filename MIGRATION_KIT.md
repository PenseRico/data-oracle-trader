# Master Migration Kit: The Oracle Protocol (V8) 🏛️📡

Este guia contém tudo o que você precisa para configurar o seu novo **Supabase** e a **Vercel** em minutos, garantindo que o sistema de 50 mil usuários rode perfeitamente.

---

### [Passo 1: Supabase (Banco de Dados)]
1. No seu novo projeto Supabase, acesse o **SQL Editor** no menu lateral.
2. Clique em **New Query**.
3. Cole o código SQL abaixo e clique em **Run**:
...
### [Passo 2: Vercel (Environment)]
Cole as chaves nas **Environment Variables** da Vercel:
*   `VITE_SUPABASE_URL`: (Tirada da aba Settings -> Data API)
*   `VITE_SUPABASE_ANON_KEY`: (Sua chave `anon` `public`)

---

**O Sistema V8 está pronto para o lançamento.** 🏛️📡💎
